...
mod tests {
    ...
    fn test_lexer_tokens() {
        ...
        assert_eq!(lexer.next_token().unwrap(), Token::Ident("x"));
    ...
    #[test]
    fn test_string_with_escape_should_fail() {
        let input = "\"hello\\n\"";
        let mut lexer = Lexer::new(input);
    ...
    fn test_nested_block_comment() {
        let input = "/* outer /* inner */ */ const x = 42;";
        let mut lexer = Lexer::new(input);
        assert_eq!(lexer.next_token().unwrap(), Token::Const);
        assert_eq!(lexer.next_token().unwrap(), Token::Ident("x"));
        assert_eq!(lexer.next_token().unwrap(), Token::Equal);
    ...
    #[test]
    fn test_single_line_comment_after_code() {
        let input = "const x = 42; // comment";
        let mut lexer = Lexer::new(input);
        assert_eq!(lexer.next_token().unwrap(), Token::Const);
        assert_eq!(lexer.next_token().unwrap(), Token::Ident("x"));
        assert_eq!(lexer.next_token().unwrap(), Token::Equal);
